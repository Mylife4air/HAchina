...
def setup_platform(hass, config, add_devices, discovery_info=None):        #装载实体
...
class Rmmin3(Entity):
    ...
    def __init__(self,hass,dev ):
        ...
        hass.services.register(DOMAIN,'send',self.send)   #注册学习服务和发送服务
